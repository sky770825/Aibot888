...
;
const {
    'beauty-html': `請幫我建立一個美業基本展示型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：美業從業者（美髮師、美甲師、美容師等）和潛在客戶 - 核心功能：工作室介紹、服務展示、環境照片、聯絡資訊 - 設計風格：優雅、專業、視覺吸引力強，使用玫瑰金和米色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、首頁、關於我們、服務項目、環境展示、聯絡我們） 2. 美業專用CSS樣式（優雅色彩、專業字體、精美卡片設計） 3. 響應式設計（手機、平板、桌面適配） 4. 工作室介紹（理念、特色、專業團隊） 5. 服務展示（美髮、美甲、美容、化妝等服務項目） 6. 環境照片展示（工作室環境、設備、氛圍照片） 7. 聯絡資訊（地址、電話、營業時間、地圖位置） 8. 基本互動功能（平滑滾動、圖片燈箱、表單驗證） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'beauty-rental-html': `請幫我建立一個美業租賃預約型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：美業從業者尋找租賃空間、工作室業主 - 核心功能：租賃方案展示、線上預約、收費標準、空間管理 - 設計風格：現代、專業、信任感，使用藍色和白色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、首頁、租賃方案、預約系統、收費標準、聯絡） 2. 租賃專用CSS樣式（現代設計、清晰收費表格、預約表單） 3. 響應式設計（手機、平板、桌面適配） 4. 租賃方案展示（時租、日租、月租方案比較） 5. 收費標準表格（美甲桌位、美髮床位、化妝台位價格） 6. 線上預約系統（日期選擇、時段預約、空間類型選擇） 7. 空間展示（不同類型工作空間照片、設備介紹） 8. 預約管理（預約確認、修改、取消功能） **收費模式參考：** - 時租：美甲桌位 NT$150-200/小時，美髮床位 NT$200-300/小時 - 日租：美甲桌位 NT$1,
    200-1,
    500/天，美髮床位 NT$1,
    500-2,
    000/天 - 月租：美甲桌位 NT$25,
    ...
    000/月，美髮床位 NT$35,
    000-45,
    000/月 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'beauty-course-html': `請幫我建立一個美業課程培訓型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：美業學習者、專業人士進修、工作室培訓 - 核心功能：課程展示、線上報名、講師介紹、學習進度追蹤 - 設計風格：教育、專業、激勵，使用紫色和金色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、首頁、課程列表、講師介紹、報名系統、學習資源） 2. 教育專用CSS樣式（專業設計、課程卡片、進度條） 3. 響應式設計（手機、平板、桌面適配） 4. 課程展示（美甲技術、美髮造型、化妝技巧、經營管理課程） 5. 講師介紹（專業背景、教學經驗、作品展示） 6. 線上報名系統（課程選擇、時間安排、付款資訊） 7. 學習進度追蹤（課程完成度、證書下載、學習記錄） 8. 學習資源（教學影片、講義下載、技術文章） **課程類型參考：** - 基礎課程：美甲基礎、美髮基礎、化妝入門 - 進階課程：日式美甲、韓式髮型、新娘化妝 - 專業課程：美業經營、客戶管理、行銷策略 - 證照課程：美甲師證照、美髮師證照、化妝師證照 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'real-estate-html': `請幫我建立一個房仲基本展示型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：房仲業務員和潛在客戶 - 核心功能：物件展示、專業介紹、客戶見證、聯絡資訊 - 設計風格：專業、信任感、使用藍色和白色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、首頁、物件展示、關於我、客戶見證、聯絡） 2. 房仲專用CSS樣式（專業色彩、信任感設計） 3. 響應式設計（手機、平板、桌面適配） 4. 物件展示區域（圖片、基本資訊、價格、特色） 5. 專業介紹（經歷、證照、服務特色、專業團隊） 6. 客戶見證區塊（推薦信、評分、成功案例） 7. 聯絡資訊（地址、電話、營業時間、地圖位置） 8. 基本互動功能（物件篩選、圖片燈箱、表單驗證） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'real-estate-rental-html': `請幫我建立一個房仲租賃管理型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：房東、租客、租賃管理需求者 - 核心功能：租賃物件展示、線上預約看房、租賃申請、合約管理 - 設計風格：現代、實用、使用綠色和白色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、首頁、租賃物件、預約看房、申請流程、聯絡） 2. 租賃專用CSS樣式（現代設計、租賃表格、預約系統） 3. 響應式設計（手機、平板、桌面適配） 4. 租賃物件展示（照片、租金、坪數、位置、設備） 5. 線上預約看房（日期選擇、時段預約、聯絡方式） 6. 租賃申請表單（個人資料、收入證明、推薦人） 7. 合約管理（租賃條款、押金說明、注意事項） 8. 基本互動功能（物件篩選、預約管理、表單驗證） **租賃服務參考：** - 看房預約：免費，需提前1天預約 - 申請費：NT$500（含背景調查） - 押金：通常為1-2個月租金 - 管理費：月租金的5-10% 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'real-estate-investment-html': `請幫我建立一個房仲投資顧問型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：房地產投資者、置產需求者、投資顧問 - 核心功能：投資物件分析、市場趨勢、投資計算、顧問服務 - 設計風格：專業、高端、使用金色和深色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、首頁、投資物件、市場分析、投資計算、顧問服務） 2. 投資專用CSS樣式（高端設計、數據圖表、投資工具） 3. 響應式設計（手機、平板、桌面適配） 4. 投資物件分析（投報率、增值潛力、風險評估） 5. 市場趨勢分析（區域發展、價格走勢、投資建議） 6. 投資計算工具（貸款試算、投報率計算、稅務規劃） 7. 顧問服務（投資諮詢、物件評估、投資組合規劃） 8. 基本互動功能（計算工具、圖表顯示、諮詢預約） **投資服務參考：** - 投資諮詢：NT$2,
    000-5,
    000/小時 - 物件評估：NT$5,
    000-15,
    000/件 - 投資組合規劃：NT$10,
    ...
    000/案 - 市場分析報告：NT$3,
    000-8,
    000/份 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'restaurant-html': `請幫我建立一個餐飲基本展示型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：餐廳顧客和潛在客戶 - 核心功能：菜單展示、餐廳介紹、環境照片、聯絡資訊 - 設計風格：溫馨、誘人、使用暖色調配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、首頁、菜單、關於我們、環境、聯絡） 2. 餐飲專用CSS樣式（溫馨色彩、美食誘人設計） 3. 響應式設計（手機、平板、桌面適配） 4. 菜單展示區域（分類、圖片、價格、描述） 5. 餐廳介紹（故事、特色、理念） 6. 環境照片展示（用餐環境、廚房、氛圍） 7. 聯絡資訊（地址、電話、營業時間、地圖） 8. 基本互動功能（菜單篩選、圖片燈箱、表單驗證） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'restaurant-delivery-html': `請幫我建立一個餐飲外送訂餐型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：外送顧客、線上訂餐用戶 - 核心功能：線上訂餐、外送服務、付款系統、訂單追蹤 - 設計風格：現代、簡潔、使用藍色和橙色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、首頁、菜單、購物車、結帳、訂單追蹤） 2. 外送專用CSS樣式（現代設計、購物體驗優化） 3. 響應式設計（手機、平板、桌面適配） 4. 菜單展示（分類、圖片、價格、描述、加購選項） 5. 購物車功能（添加、移除、數量調整、總計） 6. 結帳流程（送餐資訊、付款方式、優惠券） 7. 訂單追蹤（訂單狀態、預計送達時間） 8. 基本互動功能（菜單篩選、購物車操作、表單驗證） **外送服務參考：** - 外送費：NT$30-50（滿額免運） - 送餐時間：30-45分鐘 - 付款方式：現金、信用卡、行動支付 - 服務範圍：3公里內 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'restaurant-catering-html': `請幫我建立一個餐飲宴會外燴型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：企業客戶、活動主辦方、宴會需求者 - 核心功能：宴會方案、外燴服務、線上詢價、活動規劃 - 設計風格：專業、高級、使用金色和深色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、首頁、宴會方案、外燴服務、詢價表單、案例展示） 2. 宴會專用CSS樣式（高級設計、方案比較、案例展示） 3. 響應式設計（手機、平板、桌面適配） 4. 宴會方案展示（婚宴、商務宴會、慶生會、尾牙等） 5. 外燴服務（場地佈置、餐點準備、服務人員、設備提供） 6. 線上詢價表單（活動類型、人數、預算、特殊需求） 7. 案例展示（成功案例、客戶見證、作品集） 8. 基本互動功能（方案比較、詢價提交、案例瀏覽） **宴會方案參考：** - 婚宴：NT$800-1,
    500/人（含佈置、服務） - 商務宴會：NT$600-1,
    200/人（含簡報設備） - 慶生會：NT$400-800/人（含蛋糕、佈置） - 尾牙：NT$500-1,
    000/人（含表演、抽獎） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'fitness-html': `請幫我建立一個健身基本展示型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：健身愛好者和潛在會員 - 核心功能：課程展示、教練介紹、環境展示、聯絡資訊 - 設計風格：活力、動感、使用橙色和黑色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、首頁、課程、教練、環境、聯絡） 2. 健身專用CSS樣式（活力色彩、動感設計） 3. 響應式設計（手機、平板、桌面適配） 4. 課程展示區域（時間表、類型、強度標示） 5. 教練介紹（照片、專長、經歷、證照） 6. 環境展示（器材、空間、氛圍照片） 7. 聯絡資訊（地址、電話、營業時間、地圖） 8. 基本互動功能（課程篩選、圖片燈箱、表單驗證） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'fitness-personal-html': `請幫我建立一個健身個人教練型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：尋找個人教練的學員、健身愛好者 - 核心功能：教練預約、課程安排、進度追蹤、付款系統 - 設計風格：專業、激勵、使用藍色和綠色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、首頁、教練介紹、課程預約、進度追蹤、付款） 2. 個人教練專用CSS樣式（專業設計、預約系統、進度圖表） 3. 響應式設計（手機、平板、桌面適配） 4. 教練介紹（專業背景、專長領域、成功案例、證照） 5. 課程預約系統（時間選擇、課程類型、地點選擇） 6. 進度追蹤（體重記錄、體脂測量、目標設定、圖表顯示） 7. 付款系統（課程包購買、單次課程、會員方案） 8. 基本互動功能（預約管理、進度記錄、付款處理） **個人教練服務參考：** - 單次課程：NT$1,
    500-2,
    ...
    000/月 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'fitness-studio-html': `請幫我建立一個健身工作室租賃型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：健身教練、工作室業主、空間租賃需求者 - 核心功能：空間租賃、設備展示、預約管理、收費標準 - 設計風格：現代、專業、使用灰色和藍色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、首頁、空間展示、租賃方案、預約系統、收費標準） 2. 工作室租賃專用CSS樣式（現代設計、空間展示、租賃表格） 3. 響應式設計（手機、平板、桌面適配） 4. 空間展示（不同類型工作室、設備介紹、環境照片） 5. 租賃方案（時租、日租、月租方案比較） 6. 預約系統（空間選擇、時間預約、設備需求） 7. 收費標準（不同空間類型、設備使用費、清潔費） 8. 基本互動功能（空間篩選、預約管理、費用計算） **租賃方案參考：** - 時租：NT$200-500/小時（含基本設備） - 日租：NT$1,
    500-3,
    000/天（含所有設備） - 月租：NT$25,
    000-50,
    000/月（專屬空間） - 設備租賃：NT$500-1,
    500/天（特殊設備） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'ecommerce-html': `請幫我建立一個電商基本展示型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：線上購物者和潛在客戶 - 核心功能：商品展示、購物車、結帳流程、會員登入 - 設計風格：現代、簡潔、使用藍色和白色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、商品列表、購物車、結帳、會員） 2. 電商專用CSS樣式（現代設計、購物體驗優化） 3. 響應式設計（手機、平板、桌面適配） 4. 商品展示區域（圖片、價格、描述、分類） 5. 購物車功能（添加、移除、數量調整） 6. 結帳流程（表單、總計、付款方式） 7. 會員登入（註冊、登入表單） 8. 基本互動功能（商品篩選、購物車操作） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'ecommerce-marketplace-html': `請幫我建立一個電商多賣家市集型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：多個賣家、買家、市集管理員 - 核心功能：賣家註冊、商品管理、訂單處理、佣金系統 - 設計風格：多元、活潑、使用彩色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、首頁、賣家專區、商品瀏覽、訂單管理、客服） 2. 市集專用CSS樣式（多元設計、賣家專區、商品分類） 3. 響應式設計（手機、平板、桌面適配） 4. 賣家註冊系統（賣家資料、商店設定、商品上架） 5. 商品管理（商品分類、庫存管理、價格設定） 6. 訂單處理（訂單追蹤、出貨管理、退換貨） 7. 佣金系統（銷售報表、佣金計算、提現申請） 8. 基本互動功能（賣家篩選、商品搜尋、訂單管理） **市集服務參考：** - 賣家註冊費：NT$500（一次性） - 平台佣金：3-8%（依商品類別） - 金流手續費：2-3% - 廣告推廣：NT$1,
    000-5,
    000/月 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'ecommerce-subscription-html': `請幫我建立一個電商訂閱制型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：訂閱制服務提供者、訂閱用戶 - 核心功能：訂閱方案、定期配送、會員管理、自動續費 - 設計風格：簡約、專業、使用綠色和白色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、首頁、訂閱方案、會員專區、配送管理、客服） 2. 訂閱專用CSS樣式（簡約設計、方案比較、會員專區） 3. 響應式設計（手機、平板、桌面適配） 4. 訂閱方案展示（月費、季費、年費方案比較） 5. 會員專區（訂閱狀態、配送記錄、偏好設定） 6. 配送管理（配送地址、配送時間、暫停配送） 7. 自動續費（付款方式、續費提醒、取消訂閱） 8. 基本互動功能（方案選擇、會員登入、配送設定） **訂閱服務參考：** - 月費方案：NT$299-999/月 - 季費方案：NT$799-2,
    499/季（9折優惠） - 年費方案：NT$2,
    999-9,
    999/年（8折優惠） - 配送費：NT$60-120（滿額免運） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'project-management-html': `請幫我建立一個專案管理基本型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：專案經理和團隊成員 - 核心功能：任務追蹤、團隊協作、進度管理、時間統計 - 設計風格：專業、清晰、使用綠色和灰色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、看板、任務、團隊、統計） 2. 專案管理專用CSS樣式（清晰設計、狀態指示） 3. 響應式設計（手機、平板、桌面適配） 4. 看板管理（待辦、進行中、已完成） 5. 任務卡片（標題、描述、負責人、截止日期） 6. 團隊協作（成員列表、角色分配） 7. 進度統計（完成率、時間追蹤） 8. 基本互動功能（拖拽、篩選、表單操作） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'project-management-agile-html': `請幫我建立一個專案管理敏捷開發型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：敏捷開發團隊、Scrum Master、產品經理 - 核心功能：Sprint規劃、用戶故事、燃盡圖、回顧會議 - 設計風格：活潑、動態、使用藍色和橙色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、Sprint看板、用戶故事、燃盡圖、回顧） 2. 敏捷專用CSS樣式（動態設計、Sprint視覺化、燃盡圖表） 3. 響應式設計（手機、平板、桌面適配） 4. Sprint規劃（Sprint目標、時間範圍、容量規劃） 5. 用戶故事管理（故事點估算、優先級、驗收標準） 6. 燃盡圖顯示（剩餘工作、完成進度、趨勢分析） 7. 回顧會議（Sprint回顧、改進建議、行動項目） 8. 基本互動功能（故事拖拽、點數估算、圖表更新） **敏捷開發參考：** - Sprint長度：1-4週 - 每日站會：15分鐘 - Sprint規劃：2-4小時 - 回顧會議：1-2小時 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'project-management-consulting-html': `請幫我建立一個專案管理顧問服務型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：企業客戶、專案管理顧問、諮詢服務提供者 - 核心功能：顧問服務、專案評估、培訓課程、諮詢預約 - 設計風格：專業、高端、使用深藍色和金色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、首頁、服務介紹、專案評估、培訓課程、諮詢預約） 2. 顧問專用CSS樣式（高端設計、服務展示、客戶見證） 3. 響應式設計（手機、平板、桌面適配） 4. 顧問服務介紹（專案管理諮詢、流程改善、團隊培訓） 5. 專案評估工具（專案健康度檢查、風險評估、改善建議） 6. 培訓課程（PMP認證、敏捷認證、專案管理基礎） 7. 諮詢預約系統（時間選擇、服務類型、預約確認） 8. 基本互動功能（評估工具、課程報名、預約管理） **顧問服務參考：** - 專案評估：NT$10,
    000-30,
    000/案 - 流程改善：NT$50,
    000-150,
    000/案 - 團隊培訓：NT$20,
    ...
    000/天 - 諮詢服務：NT$3,
    000-8,
    000/小時 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'note-taking-html': `請幫我建立一個簡單的個人筆記系統（HTML方案），包含以下功能： **專案需求：** - 目標用戶：個人用戶和知識工作者 - 核心功能：筆記管理、標籤分類、搜尋功能、雲端同步 - 設計風格：簡潔、專注、使用紫色和白色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、筆記列表、編輯器、標籤、搜尋） 2. 筆記專用CSS樣式（簡潔設計、閱讀體驗優化） 3. 響應式設計（手機、平板、桌面適配） 4. 筆記列表（標題、預覽、日期、標籤） 5. 筆記編輯器（標題、內容、格式化） 6. 標籤系統（分類、篩選、管理） 7. 搜尋功能（全文搜尋、標籤搜尋） 8. 基本互動功能（編輯、刪除、標籤操作） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'note-taking-knowledge-html': `請幫我建立一個知識管理型筆記網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：研究人員、學者、知識工作者、企業團隊 - 核心功能：知識庫建立、關聯圖、引用系統、協作編輯 - 設計風格：專業、結構化、學術感，使用深綠色和米色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、知識庫、關聯圖、引用管理、協作） 2. 知識管理CSS樣式（專業設計、關聯圖、引用卡片） 3. 響應式設計（手機、平板、桌面適配） 4. 知識庫建立（主題分類、子分類、知識點管理） 5. 關聯圖功能（知識點關聯、視覺化圖表、關係探索） 6. 引用系統（文獻引用、來源追蹤、參考資料管理） 7. 協作編輯（多人編輯、版本控制、評論系統） 8. 知識搜尋（全文搜尋、關聯搜尋、智能推薦） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'note-taking-collaborative-html': `請幫我建立一個協作筆記型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：團隊、小組、專案團隊、學習小組 - 核心功能：多人協作、權限管理、即時同步、討論區 - 設計風格：現代、協作、互動，使用橙色和藍色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、團隊空間、協作筆記、討論區、成員管理） 2. 協作專用CSS樣式（現代設計、協作指示、討論氣泡） 3. 響應式設計（手機、平板、桌面適配） 4. 多人協作功能（即時編輯、游標顯示、變更追蹤） 5. 權限管理（角色設定、編輯權限、檢視權限） 6. 即時同步（變更通知、自動儲存、衝突解決） 7. 討論區功能（筆記評論、團隊討論、@提及） 8. 成員管理（邀請成員、角色分配、活動記錄） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'personal-finance-html': `請幫我建立一個簡單的個人理財工具（HTML方案），包含以下功能： **專案需求：** - 目標用戶：個人用戶和理財愛好者 - 核心功能：記帳管理、預算規劃、投資追蹤、財務報表 - 設計風格：專業、信任、使用綠色和藍色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、記帳、預算、投資、報表） 2. 理財專用CSS樣式（專業設計、數據視覺化） 3. 響應式設計（手機、平板、桌面適配） 4. 記帳功能（收入、支出、分類、日期） 5. 預算規劃（設定、追蹤、提醒） 6. 投資追蹤（投資組合、收益計算） 7. 財務報表（圖表、統計、趨勢） 8. 基本互動功能（數據輸入、圖表顯示） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'personal-finance-budget-html': `請幫我建立一個個人理財預算規劃型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：預算規劃者、理財初學者、家庭理財需求者 - 核心功能：預算設定、支出追蹤、預算警報、財務目標 - 設計風格：直觀、警示、目標導向，使用紅色和綠色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、預算設定、支出追蹤、警報、目標） 2. 預算專用CSS樣式（直觀設計、警示系統、進度條） 3. 響應式設計（手機、平板、桌面適配） 4. 預算設定功能（類別預算、月度預算、年度預算） 5. 支出追蹤（即時記錄、類別分析、趨勢圖表） 6. 預算警報（超支提醒、目標達成通知） 7. 財務目標（儲蓄目標、債務清償、投資目標） 8. 報表分析（預算執行率、支出分析、建議） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'personal-finance-investment-html': `請幫我建立一個個人理財投資追蹤型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：投資者、理財進階者、投資組合管理者 - 核心功能：投資組合、績效追蹤、風險分析、投資建議 - 設計風格：專業、數據導向、風險警示，使用深藍色和金色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、投資組合、績效分析、風險評估、建議） 2. 投資專用CSS樣式（專業設計、圖表展示、風險指示） 3. 響應式設計（手機、平板、桌面適配） 4. 投資組合管理（股票、基金、債券、其他投資） 5. 績效追蹤（投資報酬率、累積收益、年化報酬） 6. 風險分析（投資組合風險、個別標的風險、相關性分析） 7. 投資建議（再平衡建議、風險調整、投資機會） 8. 市場資訊（即時價格、新聞、分析報告） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'online-learning-html': `請幫我建立一個簡單的線上學習平台（HTML方案），包含以下功能： **專案需求：** - 目標用戶：學習者和教育工作者 - 核心功能：課程管理、學習進度、測驗系統、證書頒發 - 設計風格：教育、專業、使用藍色和橙色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、課程、進度、測驗、證書） 2. 教育專用CSS樣式（專業設計、學習體驗優化） 3. 響應式設計（手機、平板、桌面適配） 4. 課程展示（分類、描述、講師、時長） 5. 學習進度（完成率、章節、時間追蹤） 6. 測驗系統（題目、答案、評分） 7. 證書管理（完成證書、下載功能） 8. 基本互動功能（課程篩選、進度更新） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'online-learning-interactive-html': `請幫我建立一個線上學習互動型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：互動學習愛好者、線上教育者、學習社群 - 核心功能：互動課程、即時問答、學習社群、遊戲化學習 - 設計風格：互動、活潑、遊戲化，使用彩色和動畫效果 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、互動課程、即時問答、學習社群、成就系統） 2. 互動專用CSS樣式（動畫效果、遊戲化元素、社群介面） 3. 響應式設計（手機、平板、桌面適配） 4. 互動課程（影片互動、即時測驗、模擬練習） 5. 即時問答（線上討論、講師回答、同儕互助） 6. 學習社群（討論區、學習小組、經驗分享） 7. 遊戲化學習（積分系統、成就徽章、排行榜） 8. 學習分析（學習軌跡、弱點分析、個性化建議） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'online-learning-certification-html': `請幫我建立一個線上學習證照考試型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：證照考生、專業人士、企業培訓 - 核心功能：證照課程、模擬考試、成績分析、證書管理 - 設計風格：專業、嚴謹、權威，使用深藍色和金色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、證照課程、模擬考試、成績分析、證書中心） 2. 證照專用CSS樣式（專業設計、考試介面、證書展示） 3. 響應式設計（手機、平板、桌面適配） 4. 證照課程（課程大綱、學習進度、重點整理） 5. 模擬考試（題庫練習、模擬測驗、時間限制） 6. 成績分析（詳細分析、弱點識別、改善建議） 7. 證書管理（證書申請、進度追蹤、下載列印） 8. 考試監控（防作弊機制、時間控制、成績驗證） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'medical-clinic-html': `請幫我建立一個簡單的醫療診所網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：病患和潛在客戶 - 核心功能：線上掛號、醫師介紹、服務項目、健康資訊 - 設計風格：專業、信任、使用藍色和白色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、首頁、醫師、服務、掛號、聯絡） 2. 醫療專用CSS樣式（專業設計、信任感建立） 3. 響應式設計（手機、平板、桌面適配） 4. 醫師介紹（照片、專長、經歷、時段） 5. 服務項目（科別、檢查、治療項目） 6. 線上掛號（日期、時段、醫師選擇） 7. 健康資訊（文章、衛教、常見問題） 8. 基本互動功能（掛號預約、表單驗證） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'medical-clinic-telemedicine-html': `請幫我建立一個醫療診所遠距醫療型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：遠距醫療患者、偏遠地區患者、慢性病患者 - 核心功能：視訊看診、線上處方、健康監測、遠距照護 - 設計風格：醫療、科技、便利，使用藍色和綠色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、視訊看診、健康監測、處方管理、照護記錄） 2. 遠距醫療CSS樣式（科技感設計、視訊介面、健康圖表） 3. 響應式設計（手機、平板、桌面適配） 4. 視訊看診（預約系統、視訊通話、診療記錄） 5. 線上處方（處方開立、藥品查詢、用藥提醒） 6. 健康監測（生命徵象記錄、健康趨勢、異常警報） 7. 遠距照護（照護計劃、追蹤提醒、家屬通知） 8. 醫療資訊（健康知識、用藥指南、緊急聯絡） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'medical-clinic-management-html': `請幫我建立一個醫療診所管理型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：診所管理員、醫護人員、行政人員 - 核心功能：病患管理、排班系統、庫存管理、財務報表 - 設計風格：管理、專業、效率，使用深灰色和藍色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、病患管理、排班系統、庫存管理、財務報表） 2. 管理專用CSS樣式（專業設計、數據表格、管理介面） 3. 響應式設計（手機、平板、桌面適配） 4. 病患管理（病歷記錄、就診歷史、聯絡資訊） 5. 排班系統（醫師排班、護理排班、診間安排） 6. 庫存管理（藥品庫存、醫療用品、進銷存管理） 7. 財務報表（收入統計、支出分析、營運報表） 8. 系統設定（權限管理、參數設定、備份還原） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'community-management-html': `請幫我建立一個簡單的社區管理系統（HTML方案），包含以下功能： **專案需求：** - 目標用戶：社區住戶和管理員 - 核心功能：公告發布、維修申請、費用繳納、鄰里交流 - 設計風格：親切、實用、使用綠色和白色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、公告、維修、費用、交流、聯絡） 2. 社區專用CSS樣式（親切設計、實用性優先） 3. 響應式設計（手機、平板、桌面適配） 4. 公告系統（重要通知、活動公告、分類） 5. 維修申請（問題描述、照片上傳、進度追蹤） 6. 費用管理（繳費記錄、帳單查詢、線上繳費） 7. 鄰里交流（討論區、活動分享、聯絡資訊） 8. 基本互動功能（表單提交、狀態更新） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'community-management-social-html': `請幫我建立一個社群管理社交互動型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：活躍社群成員、社交愛好者、鄰里互動需求者 - 核心功能：社交互動、活動組織、鄰里交流、興趣小組 - 設計風格：社交、活潑、互動，使用彩色和動態效果 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、社交動態、活動中心、興趣小組、鄰里地圖） 2. 社交專用CSS樣式（動態設計、互動元素、社群介面） 3. 響應式設計（手機、平板、桌面適配） 4. 社交動態（貼文分享、按讚評論、即時互動） 5. 活動組織（活動發布、報名系統、活動管理） 6. 興趣小組（小組建立、成員管理、討論區） 7. 鄰里地圖（地標標記、推薦地點、路線規劃） 8. 鄰里交流（聊天室、訊息系統、通知中心） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'community-management-moderator-html': `請幫我建立一個社群管理管理員工具型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：社群管理員、版主、系統管理員 - 核心功能：內容審核、用戶管理、數據分析、系統設定 - 設計風格：管理、專業、效率，使用深藍色和灰色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、內容審核、用戶管理、數據分析、系統設定） 2. 管理專用CSS樣式（專業設計、管理介面、數據表格） 3. 響應式設計（手機、平板、桌面適配） 4. 內容審核（貼文審核、違規處理、舉報管理） 5. 用戶管理（用戶權限、封鎖解封、行為記錄） 6. 數據分析（活躍度統計、內容分析、用戶行為） 7. 系統設定（權限設定、規則管理、通知設定） 8. 管理工具（批量操作、自動化規則、備份還原） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'goal-tracking-html': `請幫我建立一個簡單的目標追蹤工具（HTML方案），包含以下功能： **專案需求：** - 目標用戶：個人用戶和目標導向者 - 核心功能：目標設定、進度追蹤、習慣養成、成就系統 - 設計風格：激勵、清晰、使用橙色和紫色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、目標、進度、習慣、成就、統計） 2. 目標追蹤專用CSS樣式（激勵設計、進度視覺化） 3. 響應式設計（手機、平板、桌面適配） 4. 目標設定（標題、描述、期限、類別） 5. 進度追蹤（完成率、里程碑、時間軸） 6. 習慣養成（每日打卡、連續天數、提醒） 7. 成就系統（徽章、等級、獎勵） 8. 基本互動功能（進度更新、習慣記錄） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'goal-tracking-habit-html': `請幫我建立一個目標追蹤習慣養成型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：習慣養成者、自律追求者、生活改善者 - 核心功能：習慣追蹤、連擊記錄、習慣分析、激勵系統 - 設計風格：激勵、簡潔、成就感，使用綠色和金色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、習慣列表、連擊記錄、習慣分析、激勵中心） 2. 習慣專用CSS樣式（激勵設計、連擊動畫、進度條） 3. 響應式設計（手機、平板、桌面適配） 4. 習慣追蹤（習慣建立、每日記錄、完成狀態） 5. 連擊記錄（連續天數、最佳記錄、里程碑） 6. 習慣分析（完成率、趨勢分析、弱點識別） 7. 激勵系統（成就徽章、獎勵機制、社交分享） 8. 習慣建議（科學建議、個性化推薦、社群支援） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'goal-tracking-team-html': `請幫我建立一個目標追蹤團隊目標型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：團隊、小組、專案團隊、協作組織 - 核心功能：團隊目標、協作追蹤、進度同步、團隊激勵 - 設計風格：協作、團隊、激勵，使用藍色和橙色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、團隊目標、協作看板、進度同步、團隊激勵） 2. 團隊專用CSS樣式（協作設計、看板介面、團隊元素） 3. 響應式設計（手機、平板、桌面適配） 4. 團隊目標（目標設定、責任分配、里程碑規劃） 5. 協作追蹤（任務分配、進度更新、協作記錄） 6. 進度同步（即時更新、狀態同步、通知系統） 7. 團隊激勵（團隊成就、個人貢獻、激勵機制） 8. 團隊分析（團隊績效、個人貢獻、改善建議） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'event-management-html': `請幫我建立一個簡單的活動管理平台（HTML方案），包含以下功能： **專案需求：** - 目標用戶：活動主辦方和參與者 - 核心功能：活動發布、報名管理、票務系統、活動統計 - 設計風格：活潑、吸引、使用紅色和黃色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、活動、報名、票務、統計、管理） 2. 活動管理專用CSS樣式（活潑設計、吸引力強） 3. 響應式設計（手機、平板、桌面適配） 4. 活動展示（標題、描述、時間、地點、票價） 5. 報名系統（個人資訊、票種選擇、付款） 6. 票務管理（票券生成、驗證、統計） 7. 活動統計（報名人數、收入、參與度） 8. 基本互動功能（報名流程、票務操作） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'custom-html': `請幫我建立一個客製化的網站（HTML方案），根據以下需求： **專案需求：** - 目標用戶：根據您的需求自訂 - 核心功能：根據您的需求自訂 - 設計風格：根據您的需求自訂 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（根據需求設計導航和區塊） 2. 客製化CSS樣式（根據需求設計色彩和佈局） 3. 響應式設計（手機、平板、桌面適配） 4. 核心功能實作（根據需求實作主要功能） 5. 互動功能（根據需求實作用戶互動） 6. 表單處理（根據需求實作表單驗證和提交） 7. 內容管理（根據需求實作內容展示） 8. SEO優化（根據需求實作搜尋引擎優化） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'event-management-ticketing-html': `請幫我建立一個活動管理票務銷售型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：票務銷售者、活動主辦方、票務代理商 - 核心功能：票務銷售、座位選擇、付款處理、票券管理 - 設計風格：商業、專業、信任，使用深藍色和金色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、票務銷售、座位選擇、付款處理、票券管理） 2. 票務專用CSS樣式（商業設計、座位圖、付款介面） 3. 響應式設計（手機、平板、桌面適配） 4. 票務銷售（票價設定、座位圖、票券類型） 5. 座位選擇（互動座位圖、座位狀態、選擇確認） 6. 付款處理（多種付款方式、安全驗證、收據生成） 7. 票券管理（票券生成、驗證系統、退票處理） 8. 銷售分析（銷售統計、收入分析、熱門座位） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
    'event-management-corporate-html': `請幫我建立一個活動管理企業活動型網站（HTML方案），包含以下功能： **專案需求：** - 目標用戶：企業活動主辦方、HR部門、企業培訓師 - 核心功能：企業活動、員工管理、培訓課程、活動分析 - 設計風格：企業、專業、效率，使用深灰色和藍色配色 - 技術要求：純HTML + CSS + JavaScript，響應式設計 **請依序實作：** 1. 單頁面HTML結構（導航、企業活動、員工管理、培訓課程、活動分析） 2. 企業專用CSS樣式（專業設計、企業風格、管理介面） 3. 響應式設計（手機、平板、桌面適配） 4. 企業活動（會議、培訓、團建、年會） 5. 員工管理（員工資料、權限設定、參與記錄） 6. 培訓課程（課程安排、講師管理、學習追蹤） 7. 活動分析（參與率、滿意度、效果評估） 8. 企業設定（公司資訊、部門管理、權限控制） 請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`
}
;
document.addEventListener('click',
    function(e){
