...
if "%choice%"=="10" goto fix_git_connection
...
echo ================================
echo.
echo 您的倉庫地址：https://github.com/sky770825/Aibot888
echo.
pause
goto start
...
echo.
echo 上傳時間：%date% %time%
echo 倉庫地址：https://github.com/sky770825/Aibot888
echo 網站地址：https://sky770825.github.io/Aibot888/
echo.
pause
goto start
...
set /p repo_choice=請選擇要連接的倉庫 (1): 

if "%repo_choice%"=="1" (
    echo.
    echo 請輸入自訂倉庫地址
    echo 範例: https://github.com/username/repo.git
    set /p custom_repo=倉庫地址: 
    echo.
    echo 您輸入的地址: %custom_repo%
    echo.
    if "%custom_repo%"=="" (
        echo ❌ 倉庫地址不能為空
        pause
