...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'real-estate-html': `請幫我建立一個簡單的房仲個人網頁（HTML方案），包含以下功能：
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'ecommerce-html': `請幫我建立一個簡單的電商購物網站（HTML方案），包含以下功能：
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'project-management-html': `請幫我建立一個簡單的專案管理工具（HTML方案），包含以下功能：
