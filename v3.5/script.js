...
function initializeTemplateCopy() {
    ...
    const templateCommands = {
        'crypto-monitor': `請幫我建立一個專業的虛擬貨幣市場監控網站，具備完整的市場監控功能：

**🎯 專案需求：**
- 目標用戶：加密貨幣投資者、交易員、市場分析師
- 核心功能：實時價格監控、市場分析、投資組合管理、技術分析
- 設計風格：專業深色主題、現代化數據視覺化、金融級界面設計
- 技術要求：純HTML + CSS + JavaScript + Chart.js，完全響應式設計

**🚀 核心功能特色：**
- 實時價格監控：顯示熱門加密貨幣的即時價格和變化
- 市場分析儀表板：總市值、交易量、市場趨勢分析
- 投資組合管理：個人持倉追蹤、收益計算、資產分配
- 技術分析圖表：價格走勢圖、K線圖、技術指標
- 市場情緒指標：恐慌貪婪指數、市場主導地位分析
- 深色主題設計：專業的深色界面，適合長時間監控
...
**🎨 視覺設計要求：**
- 深色主題配色：深藍色背景 + 綠色/紅色點綴
- 現代化UI：使用漸層、玻璃質感、動畫效果
- 直觀的數據視覺化：清晰的圖表、指標、統計數據
- 實時更新動畫：價格變化時的視覺反饋
- 專業字體：Inter 或 Roboto 字體
- 響應式設計：支援桌面、平板、手機各種裝置

**📱 頁面結構：**
1. 導航欄：Logo、主要功能選單、主題切換
2. Hero區塊：總市值、交易量、活躍幣種統計
3. 價格監控：熱門幣種卡片式展示
4. 市場分析：主要圖表區域，顯示價格走勢
5. 投資組合：個人持倉明細、收益統計
6. 市場情緒：恐慌貪婪指數、市場主導地位

**🔧 技術實作要求：**
- 使用Chart.js進行數據視覺化
- 整合CoinGecko API獲取實時數據
- 實現WebSocket或定時刷新機制
...
請提供完整的程式碼實作和部署指南。`
    ...
    const htmlTemplateCommands = {
        'crypto-monitor-html': `請幫我建立一個專業的虛擬貨幣市場監控網站（HTML方案），具備完整的市場監控功能：
...
請提供完整的程式碼實作和部署指南。`,
        ...
        'crypto-trading-html': `請幫我建立一個虛擬貨幣交易分析網站（HTML方案），專注於交易工具和技術分析：

**🎯 專案需求：**
- 目標用戶：加密貨幣交易員、技術分析師
- 核心功能：交易工具、技術分析、訂單管理、風險控制
- 設計風格：專業交易界面、深色主題、數據密集展示
- 技術要求：純HTML + CSS + JavaScript + Chart.js
...
請提供完整的程式碼實作。`,
        ...
        'crypto-portfolio-html': `請幫我建立一個虛擬貨幣投資組合管理網站（HTML方案），專注於資產管理和投資追蹤：

**🎯 專案需求：**
- 目標用戶：加密貨幣投資者、資產管理員
- 核心功能：投資組合追蹤、收益分析、資產配置、投資建議
- 設計風格：簡潔專業、數據導向、易於理解
- 技術要求：純HTML + CSS + JavaScript + Chart.js
...
請提供完整的現代化HTML、CSS、JavaScript程式碼，確保符合2025年最新設計趨勢，可直接在瀏覽器中完美運行。`,
        ...
        'project-management-consulting-html': `請幫我建立一個2025年現代化專案管理顧問服務型網站（HTML方案），採用最新設計趨勢和顧問服務體驗優化：

**🎯 專案需求：**
- 目標用戶：企業客戶、專案管理顧問、諮詢服務提供者、企業轉型需求者
- 核心功能：顧問服務、專案評估、培訓課程、諮詢預約
- 設計風格：專業高端、現代權威、使用深藍色和金色配色
- 技術要求：純HTML + CSS + JavaScript，完全響應式設計
...
**📱 請依序實作：**
1. **現代化HTML結構**（Hero區塊、服務介紹、專案評估、培訓課程、諮詢預約）
2. **高端CSS樣式**（高端設計、服務展示、客戶見證、動畫效果）
3. **完全響應式設計**（Mobile-first、平板、桌面完美適配）
4. **Hero首頁區塊**（顧問概覽、核心服務、成功案例、CTA按鈕）
5. **顧問服務介紹區塊**（專案管理諮詢、流程改善、團隊培訓、專業認證）
6. **專案評估工具區塊**（專案健康度檢查、風險評估、改善建議、數據分析）
7. **培訓課程區塊**（PMP認證、敏捷認證、專案管理基礎、企業內訓）
8. **諮詢預約系統區塊**（時間選擇、服務類型、預約確認、客戶管理）
...
請提供完整的現代化HTML、CSS、JavaScript程式碼，確保符合2025年最新設計趨勢，可直接在瀏覽器中完美運行。`,
        ...
        'note-taking-knowledge-html': `請幫我建立一個2025年現代化知識管理型筆記網站（HTML方案），採用最新設計趨勢和知識管理體驗優化：

**🎯 專案需求：**
- 目標用戶：研究人員、學者、知識工作者、企業團隊、學術機構
- 核心功能：知識庫建立、關聯圖、引用系統、協作編輯
- 設計風格：專業結構化、學術權威、使用深綠色和米色配色
- 技術要求：純HTML + CSS + JavaScript，完全響應式設計

**🚀 2025年最新設計特色：**
- 一頁式滾動設計，流暢的頁面轉場動畫
- 專業結構化風格 + 玻璃質感（Glassmorphism）效果
- 深色/淺色主題切換，適應不同使用情境
- 人本數位化設計，強調知識管理和學術嚴謹性
- AI輔助知識管理，智能推薦和關聯分析
- 包容性設計，考慮不同研究領域和知識需求

**📱 請依序實作：**
1. **現代化HTML結構**（Hero區塊、知識庫、關聯圖、引用管理、協作）
2. **專業CSS樣式**（專業設計、關聯圖、引用卡片、動畫效果）
3. **完全響應式設計**（Mobile-first、平板、桌面完美適配）
4. **Hero首頁區塊**（知識概覽、核心功能、快速建立、CTA按鈕）
5. **知識庫建立區塊**（主題分類、子分類、知識點管理、結構化編輯）
6. **關聯圖功能區塊**（知識點關聯、視覺化圖表、關係探索、智能分析）
7. **引用系統區塊**（文獻引用、來源追蹤、參考資料管理、自動引用）
8. **協作編輯區塊**（多人編輯、版本控制、評論系統、即時同步）
...
請提供完整的現代化HTML、CSS、JavaScript程式碼，確保符合2025年最新設計趨勢，可直接在瀏覽器中完美運行。`,
        ...
        'note-taking-collaborative-html': `請幫我建立一個2025年現代化協作筆記型網站（HTML方案），採用最新設計趨勢和團隊協作體驗優化：

**🎯 專案需求：**
- 目標用戶：團隊、小組、專案團隊、學習小組、企業協作需求者
- 核心功能：多人協作、權限管理、即時同步、討論區
- 設計風格：現代協作、互動友善、使用橙色和藍色配色
- 技術要求：純HTML + CSS + JavaScript，完全響應式設計

**🚀 2025年最新設計特色：**
- 一頁式滾動設計，流暢的頁面轉場動畫
- 現代協作風格 + 玻璃質感（Glassmorphism）效果
- 深色/淺色主題切換，適應不同使用情境
- 人本數位化設計，強調團隊協作和互動性
- AI輔助協作功能，智能推薦和自動化管理
- 包容性設計，考慮不同團隊規模和協作需求
...
**📱 請依序實作：**
1. **現代化HTML結構**（Hero區塊、團隊空間、協作筆記、討論區、成員管理）
2. **協作CSS樣式**（現代設計、協作指示、討論氣泡、動畫效果）
3. **完全響應式設計**（Mobile-first、平板、桌面完美適配）
4. **Hero首頁區塊**（團隊概覽、協作功能、快速建立、CTA按鈕）
5. **多人協作功能區塊**（即時編輯、游標顯示、變更追蹤、協作指示）
6. **權限管理區塊**（角色設定、編輯權限、檢視權限、安全控制）
7. **即時同步區塊**（變更通知、自動儲存、衝突解決、版本管理）
8. **討論區功能區塊**（筆記評論、團隊討論、@提及、即時通訊）
...
請提供完整的現代化HTML、CSS、JavaScript程式碼，確保符合2025年最新設計趨勢，可直接在瀏覽器中完美運行。`,
        ...
        'personal-finance-investment-html': `請幫我建立一個2025年現代化個人理財投資追蹤型網站（HTML方案），採用最新設計趨勢和投資管理體驗優化：

**🎯 專案需求：**
- 目標用戶：投資者、理財進階者、投資組合管理者、專業投資人
- 核心功能：投資組合、績效追蹤、風險分析、投資建議
- 設計風格：專業數據導向、風險警示、使用深藍色和金色配色
- 技術要求：純HTML + CSS + JavaScript，完全響應式設計

**🚀 2025年最新設計特色：**
- 一頁式滾動設計，流暢的頁面轉場動畫
- 專業數據導向風格 + 玻璃質感（Glassmorphism）效果
- 深色/淺色主題切換，適應不同使用情境
- 人本數位化設計，強調投資安全和成長
- AI輔助投資分析，智能推薦和風險預警
- 包容性設計，考慮不同投資經驗和風險承受度

**📱 請依序實作：**
1. **現代化HTML結構**（Hero區塊、投資組合、績效分析、風險評估、建議）
2. **專業CSS樣式**（專業設計、圖表展示、風險指示、動畫效果）
3. **完全響應式設計**（Mobile-first、平板、桌面完美適配）
4. **Hero首頁區塊**（投資概覽、績效摘要、快速操作、CTA按鈕）
5. **投資組合管理區塊**（股票、基金、債券、其他投資、資產配置）
6. **績效追蹤區塊**（投資報酬率、累積收益、年化報酬、比較分析）
7. **風險分析區塊**（投資組合風險、個別標的風險、相關性分析、壓力測試）
8. **投資建議區塊**（再平衡建議、風險調整、投資機會、AI建議）

**🎨 視覺設計要求：**
- 使用深藍色背景 + 金色點綴（專業數據導向配色）
- 圓角設計和清晰陰影效果
- 卡片式佈局和網格系統
- 現代字體（Inter、Poppins、Source Sans Pro）
- 微互動和懸停效果
...
請提供完整的現代化HTML、CSS、JavaScript程式碼，確保符合2025年最新設計趨勢，可直接在瀏覽器中完美運行。`,
        ...
        'online-learning-certification-html': `請幫我建立一個2025年現代化線上學習證照考試型網站（HTML方案），採用最新設計趨勢和證照考試體驗優化：

**🎯 專案需求：**
- 目標用戶：證照考生、專業人士、企業培訓、職業發展需求者
- 核心功能：證照課程、模擬考試、成績分析、證書管理
- 設計風格：專業嚴謹、權威可信、使用深藍色和金色配色
- 技術要求：純HTML + CSS + JavaScript，完全響應式設計

**🚀 2025年最新設計特色：**
- 一頁式滾動設計，流暢的頁面轉場動畫
- 專業嚴謹風格 + 玻璃質感（Glassmorphism）效果
- 深色/淺色主題切換，適應不同使用情境
- 人本數位化設計，強調學習和認證權威性
- AI輔助證照學習，智能推薦和個性化學習
- 包容性設計，考慮不同學習需求和能力
...
**📱 請依序實作：**
1. **現代化HTML結構**（Hero區塊、證照課程、模擬考試、成績分析、證書中心）
2. **專業CSS樣式**（專業設計、考試介面、證書展示、動畫效果）
3. **完全響應式設計**（Mobile-first、平板、桌面完美適配）
4. **Hero首頁區塊**（證照概覽、學習進度、快速考試、CTA按鈕）
5. **證照課程區塊**（課程大綱、學習進度、重點整理、學習路徑）
6. **模擬考試區塊**（題庫練習、模擬測驗、時間限制、考試環境）
7. **成績分析區塊**（詳細分析、弱點識別、改善建議、學習建議）
8. **證書管理區塊**（證書申請、進度追蹤、下載列印、數位證書）
...
**📚 證照類型參考：**
- 基礎證照：NT$299-999/課程
- 專業證照：NT$1,999-4,999/課程
- 國際認證：NT$4,999-9,999/課程
- 企業培訓：NT$5,000-20,000/課程
...
請提供完整的現代化HTML、CSS、JavaScript程式碼，確保符合2025年最新設計趨勢，可直接在瀏覽器中完美運行。`,
        ...
        'medical-clinic-management-html': `請幫我建立一個2025年現代化醫療診所管理型網站（HTML方案），採用最新設計趨勢和診所管理體驗優化：

**🎯 專案需求：**
- 目標用戶：診所管理員、醫護人員、行政人員、醫療機構管理者
- 核心功能：病患管理、排班系統、庫存管理、財務報表
- 設計風格：管理專業、效率導向、使用深灰色和藍色配色
- 技術要求：純HTML + CSS + JavaScript，完全響應式設計

**🚀 2025年最新設計特色：**
- 一頁式滾動設計，流暢的頁面轉場動畫
- 管理專業風格 + 玻璃質感（Glassmorphism）效果
- 深色/淺色主題切換，適應不同使用情境
- 人本數位化設計，強調效率和專業管理
- AI輔助診所管理，智能分析和自動化功能
- 包容性設計，考慮不同角色和操作需求
...
**📱 請依序實作：**
1. **現代化HTML結構**（Hero區塊、病患管理、排班系統、庫存管理、財務報表）
2. **專業CSS樣式**（專業設計、數據表格、管理介面、動畫效果）
3. **完全響應式設計**（Mobile-first、平板、桌面完美適配）
4. **Hero首頁區塊**（管理概覽、核心功能、快速操作、CTA按鈕）
5. **病患管理區塊**（病歷記錄、就診歷史、聯絡資訊、健康檔案）
6. **排班系統區塊**（醫師排班、護理排班、診間安排、時段管理）
7. **庫存管理區塊**（藥品庫存、醫療用品、進銷存管理、自動補貨）
8. **財務報表區塊**（收入統計、支出分析、營運報表、數據視覺化）
...
請提供完整的現代化HTML、CSS、JavaScript程式碼，確保符合2025年最新設計趨勢，可直接在瀏覽器中完美運行。`,
        ...
        'community-management-social-html': `請幫我建立一個2025年現代化社群管理社交互動型網站（HTML方案），採用最新設計趨勢和社交互動體驗優化：

**🎯 專案需求：**
- 目標用戶：活躍社群成員、社交愛好者、鄰里互動需求者、社區建設者
- 核心功能：社交互動、活動組織、鄰里交流、興趣小組
- 設計風格：社交活潑、互動友善、使用彩色和動態效果
- 技術要求：純HTML + CSS + JavaScript，完全響應式設計

**🚀 2025年最新設計特色：**
- 一頁式滾動設計，流暢的頁面轉場動畫
- 社交活潑風格 + 玻璃質感（Glassmorphism）效果
- 深色/淺色主題切換，適應不同使用情境
- 人本數位化設計，強調社交互動和社區連結
- AI輔助社交功能，智能推薦和個性化體驗
- 包容性設計，考慮不同年齡和社交需求
...
**📱 請依序實作：**
1. **現代化HTML結構**（Hero區塊、社交動態、活動中心、興趣小組、鄰里地圖）
2. **社交CSS樣式**（動態設計、互動元素、社群介面、動畫效果）
3. **完全響應式設計**（Mobile-first、平板、桌面完美適配）
4. **Hero首頁區塊**（社群概覽、熱門動態、快速互動、CTA按鈕）
5. **社交動態區塊**（貼文分享、按讚評論、即時互動、內容推薦）
6. **活動組織區塊**（活動發布、報名系統、活動管理、參與統計）
7. **興趣小組區塊**（小組建立、成員管理、討論區、興趣匹配）
8. **鄰里交流區塊**（聊天室、訊息系統、通知中心、鄰里地圖）
...
**🎯 專案需求：**
- 目標用戶：社群管理員、版主、系統管理員、社群運營者
- 核心功能：內容審核、用戶管理、數據分析、系統設定
- 設計風格：管理專業、效率導向、使用深藍色和灰色配色
- 技術要求：純HTML + CSS + JavaScript，完全響應式設計
...
**📱 請依序實作：**
1. **現代化HTML結構**（Hero區塊、內容審核、用戶管理、數據分析、系統設定）
2. **專業CSS樣式**（專業設計、管理介面、數據表格、動畫效果）
3. **完全響應式設計**（Mobile-first、平板、桌面完美適配）
4. **Hero首頁區塊**（管理概覽、核心功能、快速操作、CTA按鈕）
5. **內容審核區塊**（貼文審核、違規處理、舉報管理、自動化審核）
6. **用戶管理區塊**（用戶權限、封鎖解封、行為記錄、批量操作）
7. **數據分析區塊**（活躍度統計、內容分析、用戶行為、趨勢預測）
8. **系統設定區塊**（權限設定、規則管理、通知設定、自動化規則）
...
請提供完整的現代化HTML、CSS、JavaScript程式碼，確保符合2025年最新設計趨勢，可直接在瀏覽器中完美運行。`,
        ...
        'goal-tracking-habit-html': `請幫我建立一個2025年現代化目標追蹤習慣養成型網站（HTML方案），採用最新設計趨勢和習慣養成體驗優化：

**🎯 專案需求：**
- 目標用戶：習慣養成者、自律追求者、生活改善者、自我提升愛好者
- 核心功能：習慣追蹤、連擊記錄、習慣分析、激勵系統
- 設計風格：激勵簡潔、成就感導向、使用綠色和金色配色
- 技術要求：純HTML + CSS + JavaScript，完全響應式設計

**🚀 2025年最新設計特色：**
- 一頁式滾動設計，流暢的頁面轉場動畫
- 激勵簡潔風格 + 玻璃質感（Glassmorphism）效果
- 深色/淺色主題切換，適應不同使用情境
- 人本數位化設計，強調激勵和成就感
- AI輔助習慣養成，智能分析和建議功能
- 包容性設計，考慮不同習慣和目標需求
...
**📱 請依序實作：**
1. **現代化HTML結構**（Hero區塊、習慣列表、連擊記錄、習慣分析、激勵中心）
2. **激勵CSS樣式**（激勵設計、連擊動畫、進度條、動畫效果）
3. **完全響應式設計**（Mobile-first、平板、桌面完美適配）
4. **Hero首頁區塊**（習慣概覽、連擊統計、快速記錄、CTA按鈕）
5. **習慣追蹤區塊**（習慣建立、每日記錄、完成狀態、智能提醒）
6. **連擊記錄區塊**（連續天數、最佳記錄、里程碑、成就展示）
7. **習慣分析區塊**（完成率、趨勢分析、弱點識別、改善建議）
8. **激勵系統區塊**（成就徽章、獎勵機制、社交分享、激勵訊息）
...
請提供完整的現代化HTML、CSS、JavaScript程式碼，確保符合2025年最新設計趨勢，可直接在瀏覽器中完美運行。`,
        ...
        'goal-tracking-team-html': `請幫我建立一個2025年現代化目標追蹤團隊目標型網站（HTML方案），採用最新設計趨勢和團隊協作體驗優化：

**🎯 專案需求：**
- 目標用戶：團隊、小組、專案團隊、協作組織、企業團隊
- 核心功能：團隊目標、協作追蹤、進度同步、團隊激勵
- 設計風格：協作團隊、激勵導向、使用藍色和橙色配色
- 技術要求：純HTML + CSS + JavaScript，完全響應式設計

**🚀 2025年最新設計特色：**
- 一頁式滾動設計，流暢的頁面轉場動畫
- 協作團隊風格 + 玻璃質感（Glassmorphism）效果
- 深色/淺色主題切換，適應不同使用情境
- 人本數位化設計，強調團隊協作和激勵
- AI輔助團隊管理，智能分析和建議功能
- 包容性設計，考慮不同團隊規模和協作需求
...
**📱 請依序實作：**
1. **現代化HTML結構**（Hero區塊、團隊目標、協作看板、進度同步、團隊激勵）
2. **協作CSS樣式**（協作設計、看板介面、團隊元素、動畫效果）
3. **完全響應式設計**（Mobile-first、平板、桌面完美適配）
4. **Hero首頁區塊**（團隊概覽、目標進度、快速協作、CTA按鈕）
5. **團隊目標區塊**（目標設定、責任分配、里程碑規劃、目標分解）
6. **協作追蹤區塊**（任務分配、進度更新、協作記錄、即時同步）
7. **進度同步區塊**（即時更新、狀態同步、通知系統、進度視覺化）
8. **團隊激勵區塊**（團隊成就、個人貢獻、激勵機制、獎勵系統）
...
請提供完整的現代化HTML、CSS、JavaScript程式碼，確保符合2025年最新設計趨勢，可直接在瀏覽器中完美運行。`,
        ...
        'event-management-ticketing-html': `請幫我建立一個2025年現代化活動管理票務銷售型網站（HTML方案），採用最新設計趨勢和票務銷售體驗優化：

**🎯 專案需求：**
- 目標用戶：票務銷售者、活動主辦方、票務代理商、票務平台運營者
- 核心功能：票務銷售、座位選擇、付款處理、票券管理
- 設計風格：商業專業、信任導向、使用深藍色和金色配色
- 技術要求：純HTML + CSS + JavaScript，完全響應式設計

**🚀 2025年最新設計特色：**
- 一頁式滾動設計，流暢的頁面轉場動畫
- 商業專業風格 + 玻璃質感（Glassmorphism）效果
- 深色/淺色主題切換，適應不同使用情境
- 人本數位化設計，強調信任和便利性
- AI輔助票務銷售，智能推薦和動態定價
- 包容性設計，考慮不同購票需求和偏好
...
**📱 請依序實作：**
1. **現代化HTML結構**（Hero區塊、票務銷售、座位選擇、付款處理、票券管理）
2. **專業CSS樣式**（商業設計、座位圖、付款介面、動畫效果）
3. **完全響應式設計**（Mobile-first、平板、桌面完美適配）
4. **Hero首頁區塊**（活動概覽、票務資訊、快速購票、CTA按鈕）
5. **票務銷售區塊**（票價設定、座位圖、票券類型、動態定價）
6. **座位選擇區塊**（互動座位圖、座位狀態、選擇確認、視覺化選擇）
7. **付款處理區塊**（多種付款方式、安全驗證、收據生成、即時確認）
8. **票券管理區塊**（票券生成、驗證系統、退票處理、電子票券）
...
請提供完整的現代化HTML、CSS、JavaScript程式碼，確保符合2025年最新設計趨勢，可直接在瀏覽器中完美運行。`,
        ...
        'event-management-corporate-html': `請幫我建立一個2025年現代化活動管理企業活動型網站（HTML方案），採用最新設計趨勢和企業活動管理體驗優化：

**🎯 專案需求：**
- 目標用戶：企業活動主辦方、HR部門、企業培訓師、企業管理者
- 核心功能：企業活動、員工管理、培訓課程、活動分析
- 設計風格：企業專業、效率導向、使用深灰色和藍色配色
- 技術要求：純HTML + CSS + JavaScript，完全響應式設計

**🚀 2025年最新設計特色：**
- 一頁式滾動設計，流暢的頁面轉場動畫
- 企業專業風格 + 玻璃質感（Glassmorphism）效果
- 深色/淺色主題切換，適應不同使用情境
- 人本數位化設計，強調效率和專業管理
- AI輔助企業活動管理，智能分析和建議功能
- 包容性設計，考慮不同企業規模和活動需求

**📱 請依序實作：**
1. **現代化HTML結構**（Hero區塊、企業活動、員工管理、培訓課程、活動分析）
2. **企業CSS樣式**（專業設計、企業風格、管理介面、動畫效果）
3. **完全響應式設計**（Mobile-first、平板、桌面完美適配）
4. **Hero首頁區塊**（企業概覽、活動統計、快速管理、CTA按鈕）
5. **企業活動區塊**（會議、培訓、團建、年會、活動規劃）
6. **員工管理區塊**（員工資料、權限設定、參與記錄、部門管理）
7. **培訓課程區塊**（課程安排、講師管理、學習追蹤、證書管理）
8. **活動分析區塊**（參與率、滿意度、效果評估、數據視覺化）
...
// ===========================================
// 手機版適配檢查器 (Mobile Responsiveness Checker)
// ===========================================
function initMobileChecker() {
    ...
    const customDeviceBtn = document.getElementById('customDeviceBtn');
    ...
    let selectedOptions = ['layout', 'typography', 'touch', 'performance', 'accessibility'];
    ...
    // 自訂尺寸
    if (customDeviceBtn) {
        customDeviceBtn.addEventListener('click', function() {
    ...
    // 檢測選項
    const optionCheckboxes = document.querySelectorAll('.option-checkboxes input[type="checkbox"]');
    ...
    // 自動檢測方向按鈕
    const autoDetectBtn = document.getElementById('autoDetectOrientation');
    if (autoDetectBtn) {
        autoDetectBtn.addEventListener('click', function() {
            ...
            // 根據當前方向設定裝置
            const device = {
                name: `自動檢測 (${currentWidth}×${currentHeight})`,
            ...
            if (orientationIndicator) {
                ...
                orientationIndicator.className = `orientation-indicator ${currentOrientation}`;
            }
    ...
    checkMobileBtn.addEventListener('click', function() {
        ...
        // 模擬檢測過程
        setTimeout(() => {
            performMobileCheck(selectedDevice, selectedOptions);
            mobileResults.style.display = 'block';
            // 使用更平滑的滾動
            setTimeout(() => {
                mobileResults.scrollIntoView({ 
                    behavior: 'smooth',
                    block: 'start',
                    inline: 'nearest'
                });
...
function performMobileCheck(device, options) {
    ...
    const layoutScore = document.getElementById('layoutScore');
    const typographyScore = document.getElementById('typographyScore');
    const touchScore = document.getElementById('touchScore');
    ...
    currentResolution.textContent = `${device.width}×${device.height} (${isLandscape ? '橫向' : '直向'})`;
    ...
    if (options.includes('layout')) {
        const layoutResult = checkLayout(device);
    ...
    if (options.includes('typography')) {
        const typographyResult = checkTypography(device);
    ...
    if (options.includes('touch')) {
        const touchResult = checkTouch(device);
    ...
    if (options.includes('performance')) {
        const performanceResult = checkPerformance(device);
    ...
    if (options.includes('accessibility')) {
        const accessibilityResult = checkAccessibility(device);
    ...
    // 計算平均分數
    const averageScore = Math.round(totalScore / options.length);
    ...
    // 顯示優化建議
    displayRecommendations(device, results);
}
...
function handleOrientationChange() {
    ...
    if (orientationIndicator) {
        ...
        orientationIndicator.className = `orientation-indicator ${orientation}`;
    }
...
function checkLayout(device) {
    ...
    if (!viewport) {
        issues.push({
            ...
            solution: '添加 <meta name="viewport" content="width=device-width, initial-scale=1.0">',
            priority: 'high'
        });
        score -= 25;
    }
    ...
    if (document.documentElement.scrollWidth > currentWidth) {
        issues.push({
            type: 'error',
            title: '存在水平滾動',
            description: `頁面寬度 ${document.documentElement.scrollWidth}px 超過${isLandscape ? '橫向' : '直向'}模式寬度 ${currentWidth}px`,
    ...
    if (images.length > 0 && responsiveImages < images.length * 0.5) {
        issues.push({
            type: 'warning',
            title: '響應式圖片不足',
            description: `只有 ${Math.round(responsiveImages/images.length*100)}% 的圖片是響應式的`,
    ...
    if (isLandscape && device.width < 768) {
        ...
        if (narrowContainers > 0) {
            issues.push({
                type: 'warning',
                title: '橫向模式容器過窄',
                description: `在橫向模式下，有 ${narrowContainers} 個容器寬度過窄，可能影響閱讀體驗`,
    ...
    if (device.device && device.device.includes('ipad-pro')) {
        ...
        if (device.width >= 1024) {
            ...
            if (mainContent) {
                ...
                if (rect.width < device.width * 0.7) {
                    issues.push({
                        ...
                        description: `在 iPad Pro 12.9" 上，主內容區域寬度僅為 ${Math.round(rect.width)}px，未充分利用大螢幕空間`,
            ...
            if (bodyFontSize < 18) {
                issues.push({
                    type: 'warning',
                    title: 'iPad Pro 字體過小',
                    description: `在 iPad Pro 大螢幕上，字體大小 ${bodyFontSize}px 可能過小，影響閱讀體驗`,
        ...
        if (smallTouchTargets > 0) {
            issues.push({
                ...
                description: `有 ${smallTouchTargets} 個觸控目標小於 44px，可能影響 Apple Pencil 操作`,
...
function checkTypography(device) {
    ...
    // 檢查主字體大小
    const bodyFontSize = parseFloat(getComputedStyle(document.body).fontSize);
    const minFontSize = device.width < 480 ? 14 : 16;
    
    if (bodyFontSize < minFontSize) {
        issues.push({
            type: 'warning',
            title: '字體過小',
            description: `主字體大小 ${bodyFontSize}px 在 ${device.width}px 寬度下可能難以閱讀`,
            solution: `將主字體大小設定為至少 ${minFontSize}px`,
            priority: 'medium'
        });
        score -= 15;
    }
...
function checkTouch(device) {
    ...
    let smallButtons = 0;
    const minTouchSize = 44; // 最小觸控目標尺寸
    ...
    if (smallButtons > 0) {
        issues.push({
            type: 'warning',
            title: '觸控目標過小',
            description: `有 ${smallButtons} 個按鈕尺寸小於建議的 ${minTouchSize}px`,
...
function checkPerformance(device) {
    ...
    if (unoptimizedImages > 0) {
        issues.push({
            type: 'warning',
            title: '圖片未優化',
            description: `有 ${unoptimizedImages} 張圖片未使用現代格式或響應式載入`,
...
function checkAccessibility(device) {
    ...
    if (missingAlt > 0) {
        issues.push({
            type: 'warning',
            title: '圖片缺少替代文字',
            description: `有 ${missingAlt} 張圖片缺少 alt 屬性`,
...
function displayMobileIssues(issues) {
    ...
    if (issues.length === 0) {
        mobileIssues.innerHTML = `
            <div class="no-issues">
                <i class="fas fa-check-circle"></i>
                <h4>🎉 太棒了！</h4>
                <p>未發現手機版適配問題，您的網站已經針對行動裝置進行了良好的優化。</p>
            </div>
        `;
        return;
    }
    ...
    issues.sort((a, b) => (priorityOrder[b.priority] || 0) - (priorityOrder[a.priority] || 0));
    
    let issuesHTML = '<div class="issues-list">';
    
    issues.forEach((issue, index) => {
        const icon = issue.type === 'error' ? 'fas fa-exclamation-triangle' : 'fas fa-exclamation-circle';
        const colorClass = issue.type === 'error' ? 'error' : 'warning';
        const priorityClass = issue.priority || 'medium';
        
        issuesHTML += `
            <div class="issue-item ${colorClass} ${priorityClass}">
...
function displayRecommendations(device, results) {
    const mobileRecommendations = document.getElementById('mobileRecommendations');
    ...
    // 初始化手機版一鍵生成解決方案功能
    initMobileSolutionGenerator(device, results);
}

// ===========================================
// 手機版一鍵生成解決方案功能 (Mobile Solution Generator)
// ===========================================
function initMobileSolutionGenerator(device, results) {
    const generateMobileSolutionBtn = document.getElementById('generateMobileSolution');
    const mobileSolutionPanel = document.getElementById('mobileSolutionPanel');
    const mobileSolutionContent = document.getElementById('mobileSolutionContent');
    const copyMobileSolutionBtn = document.getElementById('copyMobileSolution');
    ...
    // 一鍵生成解決方案按鈕事件
    generateMobileSolutionBtn.addEventListener('click', function() {
        const solution = generateMobileSolution(device, results);
        mobileSolutionContent.textContent = solution;
        mobileSolutionPanel.style.display = 'block';
        mobileSolutionPanel.scrollIntoView({ behavior: 'smooth' });
    });
    
    // 複製解決方案按鈕事件
    if (copyMobileSolutionBtn) {
        copyMobileSolutionBtn.addEventListener('click', function() {
...
function generateMobileSolution(device, results) {
    let solution = `/* 手機版優化解決方案 - 一鍵修復 */
/* 檢測裝置：${device.name} (${device.width}×${device.height}) */
/* 整體評分：${results.overallScore}/100 */
...
/* 卡片設計 */
.terminology-card, .command-card, .feature-card {
    background: white;
    border-radius: 12px;
    padding: 20px;
    margin-bottom: 20px;
...
.terminology-card:hover, .command-card:hover, .feature-card:hover {
...
/* 硬體加速 */
.container, .section, .tool-section, .terminology-card {
...
// ===========================================
// 版面優化檢測器 (Layout Optimization Checker)
// ===========================================
function initLayoutOptimizationChecker() {
    ...
    checkLayoutBtn.addEventListener('click', function() {
        // 顯示載入動畫
        ...
        setTimeout(() => {
            try {
                const results = performLayoutCheck(selectedChecks);
                displayLayoutResults(results);
                layoutResults.style.display = 'block';
                
                // 使用更平滑的滾動
                setTimeout(() => {
                    layoutResults.scrollIntoView({ 
                        behavior: 'smooth',
                        block: 'start',
                        inline: 'nearest'
                    });
...
function performLayoutCheck(selectedChecks) {
    const results = {
        ...
        score: 100,
        categories: {
            overlap: { count: 0, issues: [] },
            spacing: { count: 0, issues: [] },
            alignment: { count: 0, issues: [] },
            sizing: { count: 0, issues: [] },
            mobileLayout: { count: 0, issues: [] },
    ...
    if (selectedChecks.includes('overlap')) {
        const overlapResult = checkElementOverlap();
    ...
    if (selectedChecks.includes('spacing')) {
        const spacingResult = checkSpacingAnalysis();
    ...
    if (selectedChecks.includes('sizing')) {
        const sizingResult = checkSizing();
    ...
    if (selectedChecks.includes('mobile-layout')) {
        const mobileLayoutResult = checkMobileLayout();
    ...
    if (selectedChecks.includes('typography')) {
        const typographyResult = checkTypographyLayout();
    ...
    if (results.totalIssues > 50) {
        results.issues = results.issues.slice(0, 50);
        ...
        results.issues.push({
            type: 'info',
            title: '檢測結果已優化',
            description: `為避免性能問題，已將檢測結果限制為前 50 個問題。實際發現 ${results.issues.length} 個問題。`,
    ...
    // 計算總分
    results.score = Math.max(0, 100 - (results.totalIssues * 5));
...
function checkElementOverlap() {
    ...
    // 只檢查主要內容區域的元素，避免檢查所有元素
    const mainSelectors = [
        '.container', '.section', '.tool-section', '.terminology-card',
        '.navbar', '.hero', '.feature-card', '.command-item',
        '.mobile-checker', '.layout-results', '.analysis-content',
        '.terminology-grid', '.solutions-list', '.project-section'
    ];
    ...
    // 限制檢測數量，避免性能問題
    const maxElements = Math.min(30, visibleElements.length);
    
    for (let i = 0; i < maxElements; i++) {
        for (let j = i + 1; j < maxElements; j++) {
            ...
            if (isOverlapping(el1, el2)) {
                ...
                issues.push({
                    type: 'error',
                    title: '元素重疊',
                    description: `元素 "${el1.tagName.toLowerCase()}" 與 "${el2.tagName.toLowerCase()}" 發生重疊`,
...
function checkSpacingAnalysis() {
    ...
    // 檢查容器間距 - 限制檢測數量
    const containers = document.querySelectorAll('.container, .wrapper, .content, .section');
    const maxContainers = Math.min(10, containers.length);
    ...
    for (let i = 0; i < maxContainers; i++) {
        ...
        if (totalSpacing < 20) {
            issues.push({
                type: 'warning',
                title: '容器間距不足',
                description: `容器 "${container.className || container.tagName}" 的上下間距僅 ${totalSpacing}px`,
    ...
    // 檢查卡片間距 - 限制檢測數量
    const cards = document.querySelectorAll('.card, .terminology-card, .command-card');
    const maxCards = Math.min(20, cards.length);
    ...
    for (let i = 0; i < maxCards; i++) {
        ...
        if (margin < 16) {
            issues.push({
                type: 'warning',
                title: '卡片間距過小',
                description: `卡片間距僅 ${margin}px，建議至少 16px`,
...
function checkAlignment() {
    ...
    // 檢查文字對齊 - 限制檢測數量
    const textElements = document.querySelectorAll('h1, h2, h3, h4, h5, h6, p, .text');
    const maxTextElements = Math.min(50, textElements.length);
    const alignments = {};
    ...
    const alignmentTypes = Object.keys(alignments);
    if (alignmentTypes.length > 2) {
        issues.push({
            type: 'warning',
            title: '文字對齊不一致',
            description: `發現 ${alignmentTypes.length} 種不同的文字對齊方式`,
    ...
    const maxFlexContainers = Math.min(20, flexContainers.length);
    
    for (let i = 0; i < maxFlexContainers; i++) {
...
function checkSizing() {
    ...
    const maxButtons = Math.min(30, buttons.length);
    ...
    for (let i = 0; i < maxButtons; i++) {
        ...
        if (rect.width < 44 || rect.height < 44) {
            issues.push({
                type: 'error',
                title: '按鈕尺寸過小',
                description: `按鈕尺寸 ${Math.round(rect.width)}×${Math.round(rect.height)}px 小於建議的 44×44px`,
    ...
    // 檢查圖片尺寸 - 限制檢測數量
    const images = document.querySelectorAll('img');
    const maxImages = Math.min(20, images.length);
    ...
    for (let i = 0; i < maxImages; i++) {
        ...
        if (naturalWidth > 0 && naturalHeight > 0) {
            ...
            const ratioDiff = Math.abs(aspectRatio - naturalAspectRatio);
            
            if (ratioDiff > 0.1) {
                issues.push({
                    type: 'warning',
                    title: '圖片比例失真',
                    description: `圖片顯示比例與原始比例差異 ${Math.round(ratioDiff * 100)}%`,
...
function checkMobileLayout() {
    ...
    if (document.documentElement.scrollWidth > window.innerWidth) {
        issues.push({
            type: 'error',
            title: '存在水平滾動',
            description: `頁面寬度 ${document.documentElement.scrollWidth}px 超過視窗寬度 ${window.innerWidth}px`,
...
function checkTypographyLayout() {
    ...
    const maxHeadings = Math.min(30, headings.length);
    const fontSizeMap = {};
    ...
    // 檢查標題層級是否合理
    const h1Sizes = fontSizeMap.h1 || [];
    const h2Sizes = fontSizeMap.h2 || [];
    ...
    // 檢查行高 - 限制檢測數量
    const textElements = document.querySelectorAll('p, .text, .content');
    const maxTextElements = Math.min(20, textElements.length);
    ...
    for (let i = 0; i < maxTextElements; i++) {
        ...
        if (lineHeightRatio < 1.2) {
            issues.push({
                type: 'warning',
                title: '行高不足',
                description: `行高比例 ${lineHeightRatio.toFixed(2)} 過小，影響閱讀體驗`,
...
function displayLayoutResults(results) {
    const layoutIssues = document.getElementById('layoutIssues');
    const issueCount = document.getElementById('issueCount');
    const generateSolutionBtn = document.getElementById('generateSolution');
    
    // 更新問題計數
    issueCount.textContent = `發現 ${results.totalIssues} 個問題`;
    issueCount.className = `issue-count ${results.totalIssues > 0 ? 'has-issues' : 'no-issues'}`;
    ...
    // 按優先級排序問題
    const priorityOrder = { 'high': 3, 'medium': 2, 'low': 1 };
    results.issues.sort((a, b) => (priorityOrder[b.priority] || 0) - (priorityOrder[a.priority] || 0));
    ...
    results.issues.forEach((issue, index) => {
        ...
        issuesHTML += `
            <div class="issue-item ${colorClass} ${priorityClass}">
                ...
                ${issue.overlapArea ? `<div class="issue-details">重疊面積：${Math.round(issue.overlapArea)}px²</div>` : ''}
            </div>
        `;
    });
...
// ===========================================
// 一鍵生成解決方案功能 (One-Click Solution Generator)
// ===========================================
function initSolutionGenerator(results) {
    ...
    generateSolutionBtn.addEventListener('click', function() {
        const solution = generateComprehensiveSolution(results);
...
function generateComprehensiveSolution(results) {
    let solution = `/* 版面優化解決方案 - 一鍵修復 */
/* 檢測到 ${results.totalIssues} 個問題，以下是完整的解決方案 */
...
`;
    ...
    results.issues.forEach(issue => {
        ...
        } else if (issue.title.includes('間距') || issue.title.includes('間距')) {
            categories.spacing.push(issue);
        } else if (issue.title.includes('對齊')) {
            categories.alignment.push(issue);
        } else if (issue.title.includes('尺寸') || issue.title.includes('按鈕') || issue.title.includes('圖片')) {
            categories.sizing.push(issue);
        } else if (issue.title.includes('手機') || issue.title.includes('滾動')) {
            categories.mobileLayout.push(issue);
        } else if (issue.title.includes('字體') || issue.title.includes('行高') || issue.title.includes('標題')) {
...
@media (max-width: 768px) {
    ...
    h3 { font-size: 1.5rem; }
    p, .text, .content { font-size: 0.9rem; }
}
...
function initProjectAnalyzer() {
    ...
    analyzeBtn.addEventListener('click', function() {
        ...
        // 模擬分析過程
        setTimeout(() => {
            const analysisData = performProjectAnalysis(projectPath);
...
function performProjectAnalysis(projectPath) {
    ...
    const analysisData = {
        ...
        recommendations: [
            {
                title: '效能優化建議',
                description: '建議添加圖片懶載入和CSS/JS壓縮，提升頁面載入速度。'
            },
            {
                title: 'SEO優化建議',
                description: '添加更多meta標籤和結構化數據，提升搜尋引擎排名。'
            },
            {
                title: '無障礙設計改善',
                description: '增加更多ARIA標籤和鍵盤導航支援，提升可訪問性。'
            },
            {
                title: '行動裝置優化',
                description: '優化觸控體驗和手勢操作，提升行動裝置使用體驗。'
            },
            {
                title: '安全性加強',
                description: '添加CSP策略和輸入驗證，提升網站安全性。'
            },
            {
                title: '維護性改善',
                description: '添加錯誤監控和日誌記錄，提升專案維護效率。'
            }
        ]
    };
...
function displayAnalysisResults(data) {
    ...
    let html = `
        <div class="project-section project-info">
            <h5>📊 專案資訊</h5>
            <p><strong>專案名稱：</strong>${data.projectInfo.name}</p>
            <p><strong>專案類型：</strong>${data.projectInfo.type}</p>
            <p><strong>主要技術：</strong>${data.projectInfo.technology}</p>
            <p><strong>專案狀態：</strong>${data.projectInfo.status}</p>
            <p><strong>最後更新：</strong>${data.projectInfo.lastUpdate}</p>
        </div>
        
        <div class="project-section project-structure">
            <h5>📁 專案結構</h5>
            <p><strong>主要檔案：</strong></p>
            <ul>
                ${data.projectStructure.files.map(file => `<li>${file}</li>`).join('')}
            </ul>
            <p><strong>目錄結構：</strong></p>
            <ul>
                ${data.projectStructure.directories.map(dir => `<li>${dir}</li>`).join('')}
            </ul>
        </div>
        
        <div class="project-section project-features">
            <h5>✨ 專案功能</h5>
            <ul>
                ${data.projectFeatures.map(feature => `<li>${feature}</li>`).join('')}
            </ul>
        </div>
        
        <div class="project-section project-recommendations">
            <h5>💡 優化建議與解決方案</h5>
...
// ===========================================
// 專案一鍵生成解決方案功能 (Project Solution Generator)
// ===========================================
function initProjectSolutionGenerator(data) {
    const generateProjectSolutionBtn = document.getElementById('generateProjectSolution');
    const projectSolutionPanel = document.getElementById('projectSolutionPanel');
    const projectSolutionContent = document.getElementById('projectSolutionContent');
    const copyProjectSolutionBtn = document.getElementById('copyProjectSolution');
    ...
    // 一鍵生成解決方案按鈕事件
    generateProjectSolutionBtn.addEventListener('click', function() {
        const solution = generateProjectSolution(data);
        projectSolutionContent.textContent = solution;
        projectSolutionPanel.style.display = 'block';
        projectSolutionPanel.scrollIntoView({ behavior: 'smooth' });
    });
    
    // 複製解決方案按鈕事件
    if (copyProjectSolutionBtn) {
        copyProjectSolutionBtn.addEventListener('click', function() {
...
function generateProjectSolution(data) {
    let solution = `/* 專案優化解決方案 - 一鍵修復 */
/* 專案名稱：${data.projectInfo.name} */
/* 專案類型：${data.projectInfo.type} */
/* 主要技術：${data.projectInfo.technology} */
...
/* Meta 標籤 */
/*
<meta name="description" content="專案描述，包含主要關鍵字">
<meta name="keywords" content="關鍵字1,關鍵字2,關鍵字3">
