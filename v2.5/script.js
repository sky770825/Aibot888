...
請提供完整的程式碼實作和部署指南。`
    ...
    const htmlTemplateCommands = {
        'beauty-html': `請幫我建立一個美業基本展示型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：美業從業者（美髮師、美甲師、美容師等）和潛在客戶
- 核心功能：工作室介紹、服務展示、環境照片、聯絡資訊
- 設計風格：優雅、專業、視覺吸引力強，使用玫瑰金和米色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、首頁、關於我們、服務項目、環境展示、聯絡我們）
2. 美業專用CSS樣式（優雅色彩、專業字體、精美卡片設計）
3. 響應式設計（手機、平板、桌面適配）
4. 工作室介紹（理念、特色、專業團隊）
5. 服務展示（美髮、美甲、美容、化妝等服務項目）
6. 環境照片展示（工作室環境、設備、氛圍照片）
7. 聯絡資訊（地址、電話、營業時間、地圖位置）
8. 基本互動功能（平滑滾動、圖片燈箱、表單驗證）

請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,

        'beauty-rental-html': `請幫我建立一個美業租賃預約型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：美業從業者尋找租賃空間、工作室業主
- 核心功能：租賃方案展示、線上預約、收費標準、空間管理
- 設計風格：現代、專業、信任感，使用藍色和白色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、首頁、租賃方案、預約系統、收費標準、聯絡）
2. 租賃專用CSS樣式（現代設計、清晰收費表格、預約表單）
3. 響應式設計（手機、平板、桌面適配）
4. 租賃方案展示（時租、日租、月租方案比較）
5. 收費標準表格（美甲桌位、美髮床位、化妝台位價格）
6. 線上預約系統（日期選擇、時段預約、空間類型選擇）
7. 空間展示（不同類型工作空間照片、設備介紹）
8. 預約管理（預約確認、修改、取消功能）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'beauty-course-html': `請幫我建立一個美業課程培訓型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：美業學習者、專業人士進修、工作室培訓
- 核心功能：課程展示、線上報名、講師介紹、學習進度追蹤
- 設計風格：教育、專業、激勵，使用紫色和金色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、首頁、課程列表、講師介紹、報名系統、學習資源）
2. 教育專用CSS樣式（專業設計、課程卡片、進度條）
3. 響應式設計（手機、平板、桌面適配）
4. 課程展示（美甲技術、美髮造型、化妝技巧、經營管理課程）
5. 講師介紹（專業背景、教學經驗、作品展示）
6. 線上報名系統（課程選擇、時間安排、付款資訊）
7. 學習進度追蹤（課程完成度、證書下載、學習記錄）
8. 學習資源（教學影片、講義下載、技術文章）

**課程類型參考：**
- 基礎課程：美甲基礎、美髮基礎、化妝入門
- 進階課程：日式美甲、韓式髮型、新娘化妝
- 專業課程：美業經營、客戶管理、行銷策略
- 證照課程：美甲師證照、美髮師證照、化妝師證照

請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,

        'real-estate-html': `請幫我建立一個房仲基本展示型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：房仲業務員和潛在客戶
- 核心功能：物件展示、專業介紹、客戶見證、聯絡資訊
- 設計風格：專業、信任感、使用藍色和白色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、首頁、物件展示、關於我、客戶見證、聯絡）
2. 房仲專用CSS樣式（專業色彩、信任感設計）
3. 響應式設計（手機、平板、桌面適配）
4. 物件展示區域（圖片、基本資訊、價格、特色）
5. 專業介紹（經歷、證照、服務特色、專業團隊）
6. 客戶見證區塊（推薦信、評分、成功案例）
7. 聯絡資訊（地址、電話、營業時間、地圖位置）
8. 基本互動功能（物件篩選、圖片燈箱、表單驗證）

請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,

        'real-estate-rental-html': `請幫我建立一個房仲租賃管理型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：房東、租客、租賃管理需求者
- 核心功能：租賃物件展示、線上預約看房、租賃申請、合約管理
- 設計風格：現代、實用、使用綠色和白色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、首頁、租賃物件、預約看房、申請流程、聯絡）
2. 租賃專用CSS樣式（現代設計、租賃表格、預約系統）
3. 響應式設計（手機、平板、桌面適配）
4. 租賃物件展示（照片、租金、坪數、位置、設備）
5. 線上預約看房（日期選擇、時段預約、聯絡方式）
6. 租賃申請表單（個人資料、收入證明、推薦人）
7. 合約管理（租賃條款、押金說明、注意事項）
8. 基本互動功能（物件篩選、預約管理、表單驗證）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'real-estate-investment-html': `請幫我建立一個房仲投資顧問型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：房地產投資者、置產需求者、投資顧問
- 核心功能：投資物件分析、市場趨勢、投資計算、顧問服務
- 設計風格：專業、高端、使用金色和深色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、首頁、投資物件、市場分析、投資計算、顧問服務）
2. 投資專用CSS樣式（高端設計、數據圖表、投資工具）
3. 響應式設計（手機、平板、桌面適配）
4. 投資物件分析（投報率、增值潛力、風險評估）
5. 市場趨勢分析（區域發展、價格走勢、投資建議）
6. 投資計算工具（貸款試算、投報率計算、稅務規劃）
7. 顧問服務（投資諮詢、物件評估、投資組合規劃）
8. 基本互動功能（計算工具、圖表顯示、諮詢預約）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'restaurant-html': `請幫我建立一個餐飲基本展示型網站（HTML方案），包含以下功能：
...
**請依序實作：**
1. 單頁面HTML結構（導航、首頁、菜單、關於我們、環境、聯絡）
2. 餐飲專用CSS樣式（溫馨色彩、美食誘人設計）
3. 響應式設計（手機、平板、桌面適配）
4. 菜單展示區域（分類、圖片、價格、描述）
5. 餐廳介紹（故事、特色、理念）
6. 環境照片展示（用餐環境、廚房、氛圍）
7. 聯絡資訊（地址、電話、營業時間、地圖）
8. 基本互動功能（菜單篩選、圖片燈箱、表單驗證）

請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,

        'restaurant-delivery-html': `請幫我建立一個餐飲外送訂餐型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：外送顧客、線上訂餐用戶
- 核心功能：線上訂餐、外送服務、付款系統、訂單追蹤
- 設計風格：現代、簡潔、使用藍色和橙色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、首頁、菜單、購物車、結帳、訂單追蹤）
2. 外送專用CSS樣式（現代設計、購物體驗優化）
3. 響應式設計（手機、平板、桌面適配）
4. 菜單展示（分類、圖片、價格、描述、加購選項）
5. 購物車功能（添加、移除、數量調整、總計）
6. 結帳流程（送餐資訊、付款方式、優惠券）
7. 訂單追蹤（訂單狀態、預計送達時間）
8. 基本互動功能（菜單篩選、購物車操作、表單驗證）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'restaurant-catering-html': `請幫我建立一個餐飲宴會外燴型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：企業客戶、活動主辦方、宴會需求者
- 核心功能：宴會方案、外燴服務、線上詢價、活動規劃
- 設計風格：專業、高級、使用金色和深色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、首頁、宴會方案、外燴服務、詢價表單、案例展示）
2. 宴會專用CSS樣式（高級設計、方案比較、案例展示）
3. 響應式設計（手機、平板、桌面適配）
4. 宴會方案展示（婚宴、商務宴會、慶生會、尾牙等）
5. 外燴服務（場地佈置、餐點準備、服務人員、設備提供）
6. 線上詢價表單（活動類型、人數、預算、特殊需求）
7. 案例展示（成功案例、客戶見證、作品集）
8. 基本互動功能（方案比較、詢價提交、案例瀏覽）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'fitness-html': `請幫我建立一個健身基本展示型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：健身愛好者和潛在會員
- 核心功能：課程展示、教練介紹、環境展示、聯絡資訊
- 設計風格：活力、動感、使用橙色和黑色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、首頁、課程、教練、環境、聯絡）
2. 健身專用CSS樣式（活力色彩、動感設計）
3. 響應式設計（手機、平板、桌面適配）
4. 課程展示區域（時間表、類型、強度標示）
5. 教練介紹（照片、專長、經歷、證照）
6. 環境展示（器材、空間、氛圍照片）
7. 聯絡資訊（地址、電話、營業時間、地圖）
8. 基本互動功能（課程篩選、圖片燈箱、表單驗證）

請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,

        'fitness-personal-html': `請幫我建立一個健身個人教練型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：尋找個人教練的學員、健身愛好者
- 核心功能：教練預約、課程安排、進度追蹤、付款系統
- 設計風格：專業、激勵、使用藍色和綠色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、首頁、教練介紹、課程預約、進度追蹤、付款）
2. 個人教練專用CSS樣式（專業設計、預約系統、進度圖表）
3. 響應式設計（手機、平板、桌面適配）
4. 教練介紹（專業背景、專長領域、成功案例、證照）
5. 課程預約系統（時間選擇、課程類型、地點選擇）
6. 進度追蹤（體重記錄、體脂測量、目標設定、圖表顯示）
7. 付款系統（課程包購買、單次課程、會員方案）
8. 基本互動功能（預約管理、進度記錄、付款處理）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'fitness-studio-html': `請幫我建立一個健身工作室租賃型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：健身教練、工作室業主、空間租賃需求者
- 核心功能：空間租賃、設備展示、預約管理、收費標準
- 設計風格：現代、專業、使用灰色和藍色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、首頁、空間展示、租賃方案、預約系統、收費標準）
2. 工作室租賃專用CSS樣式（現代設計、空間展示、租賃表格）
3. 響應式設計（手機、平板、桌面適配）
4. 空間展示（不同類型工作室、設備介紹、環境照片）
5. 租賃方案（時租、日租、月租方案比較）
6. 預約系統（空間選擇、時間預約、設備需求）
7. 收費標準（不同空間類型、設備使用費、清潔費）
8. 基本互動功能（空間篩選、預約管理、費用計算）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'ecommerce-html': `請幫我建立一個電商基本展示型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：線上購物者和潛在客戶
- 核心功能：商品展示、購物車、結帳流程、會員登入
- 設計風格：現代、簡潔、使用藍色和白色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、商品列表、購物車、結帳、會員）
2. 電商專用CSS樣式（現代設計、購物體驗優化）
3. 響應式設計（手機、平板、桌面適配）
4. 商品展示區域（圖片、價格、描述、分類）
5. 購物車功能（添加、移除、數量調整）
6. 結帳流程（表單、總計、付款方式）
7. 會員登入（註冊、登入表單）
8. 基本互動功能（商品篩選、購物車操作）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'ecommerce-marketplace-html': `請幫我建立一個電商多賣家市集型網站（HTML方案），包含以下功能：
...
**請依序實作：**
1. 單頁面HTML結構（導航、首頁、賣家專區、商品瀏覽、訂單管理、客服）
2. 市集專用CSS樣式（多元設計、賣家專區、商品分類）
3. 響應式設計（手機、平板、桌面適配）
4. 賣家註冊系統（賣家資料、商店設定、商品上架）
5. 商品管理（商品分類、庫存管理、價格設定）
6. 訂單處理（訂單追蹤、出貨管理、退換貨）
7. 佣金系統（銷售報表、佣金計算、提現申請）
8. 基本互動功能（賣家篩選、商品搜尋、訂單管理）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'ecommerce-subscription-html': `請幫我建立一個電商訂閱制型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：訂閱制服務提供者、訂閱用戶
- 核心功能：訂閱方案、定期配送、會員管理、自動續費
- 設計風格：簡約、專業、使用綠色和白色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、首頁、訂閱方案、會員專區、配送管理、客服）
2. 訂閱專用CSS樣式（簡約設計、方案比較、會員專區）
3. 響應式設計（手機、平板、桌面適配）
4. 訂閱方案展示（月費、季費、年費方案比較）
5. 會員專區（訂閱狀態、配送記錄、偏好設定）
6. 配送管理（配送地址、配送時間、暫停配送）
7. 自動續費（付款方式、續費提醒、取消訂閱）
8. 基本互動功能（方案選擇、會員登入、配送設定）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'project-management-html': `請幫我建立一個專案管理基本型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：專案經理和團隊成員
- 核心功能：任務追蹤、團隊協作、進度管理、時間統計
- 設計風格：專業、清晰、使用綠色和灰色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、看板、任務、團隊、統計）
2. 專案管理專用CSS樣式（清晰設計、狀態指示）
3. 響應式設計（手機、平板、桌面適配）
4. 看板管理（待辦、進行中、已完成）
5. 任務卡片（標題、描述、負責人、截止日期）
6. 團隊協作（成員列表、角色分配）
7. 進度統計（完成率、時間追蹤）
8. 基本互動功能（拖拽、篩選、表單操作）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'project-management-agile-html': `請幫我建立一個專案管理敏捷開發型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：敏捷開發團隊、Scrum Master、產品經理
- 核心功能：Sprint規劃、用戶故事、燃盡圖、回顧會議
- 設計風格：活潑、動態、使用藍色和橙色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、Sprint看板、用戶故事、燃盡圖、回顧）
2. 敏捷專用CSS樣式（動態設計、Sprint視覺化、燃盡圖表）
3. 響應式設計（手機、平板、桌面適配）
4. Sprint規劃（Sprint目標、時間範圍、容量規劃）
5. 用戶故事管理（故事點估算、優先級、驗收標準）
6. 燃盡圖顯示（剩餘工作、完成進度、趨勢分析）
7. 回顧會議（Sprint回顧、改進建議、行動項目）
8. 基本互動功能（故事拖拽、點數估算、圖表更新）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'note-taking-html': `請幫我建立一個簡單的個人筆記系統（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：個人用戶和知識工作者
- 核心功能：筆記管理、標籤分類、搜尋功能、雲端同步
- 設計風格：簡潔、專注、使用紫色和白色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、筆記列表、編輯器、標籤、搜尋）
2. 筆記專用CSS樣式（簡潔設計、閱讀體驗優化）
3. 響應式設計（手機、平板、桌面適配）
4. 筆記列表（標題、預覽、日期、標籤）
5. 筆記編輯器（標題、內容、格式化）
6. 標籤系統（分類、篩選、管理）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'personal-finance-html': `請幫我建立一個簡單的個人理財工具（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：個人用戶和理財愛好者
- 核心功能：記帳管理、預算規劃、投資追蹤、財務報表
- 設計風格：專業、信任、使用綠色和藍色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、記帳、預算、投資、報表）
2. 理財專用CSS樣式（專業設計、數據視覺化）
3. 響應式設計（手機、平板、桌面適配）
4. 記帳功能（收入、支出、分類、日期）
5. 預算規劃（設定、追蹤、提醒）
6. 投資追蹤（投資組合、收益計算）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'personal-finance-budget-html': `請幫我建立一個個人理財預算規劃型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：預算規劃者、理財初學者、家庭理財需求者
- 核心功能：預算設定、支出追蹤、預算警報、財務目標
- 設計風格：直觀、警示、目標導向，使用紅色和綠色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、預算設定、支出追蹤、警報、目標）
2. 預算專用CSS樣式（直觀設計、警示系統、進度條）
3. 響應式設計（手機、平板、桌面適配）
4. 預算設定功能（類別預算、月度預算、年度預算）
5. 支出追蹤（即時記錄、類別分析、趨勢圖表）
6. 預算警報（超支提醒、目標達成通知）
7. 財務目標（儲蓄目標、債務清償、投資目標）
8. 報表分析（預算執行率、支出分析、建議）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'online-learning-html': `請幫我建立一個簡單的線上學習平台（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：學習者和教育工作者
- 核心功能：課程管理、學習進度、測驗系統、證書頒發
- 設計風格：教育、專業、使用藍色和橙色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、課程、進度、測驗、證書）
2. 教育專用CSS樣式（專業設計、學習體驗優化）
3. 響應式設計（手機、平板、桌面適配）
4. 課程展示（分類、描述、講師、時長）
5. 學習進度（完成率、章節、時間追蹤）
6. 測驗系統（題目、答案、評分）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'online-learning-interactive-html': `請幫我建立一個線上學習互動型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：互動學習愛好者、線上教育者、學習社群
- 核心功能：互動課程、即時問答、學習社群、遊戲化學習
- 設計風格：互動、活潑、遊戲化，使用彩色和動畫效果
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、互動課程、即時問答、學習社群、成就系統）
2. 互動專用CSS樣式（動畫效果、遊戲化元素、社群介面）
3. 響應式設計（手機、平板、桌面適配）
4. 互動課程（影片互動、即時測驗、模擬練習）
5. 即時問答（線上討論、講師回答、同儕互助）
6. 學習社群（討論區、學習小組、經驗分享）
7. 遊戲化學習（積分系統、成就徽章、排行榜）
8. 學習分析（學習軌跡、弱點分析、個性化建議）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'medical-clinic-html': `請幫我建立一個簡單的醫療診所網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：病患和潛在客戶
- 核心功能：線上掛號、醫師介紹、服務項目、健康資訊
- 設計風格：專業、信任、使用藍色和白色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、首頁、醫師、服務、掛號、聯絡）
2. 醫療專用CSS樣式（專業設計、信任感建立）
3. 響應式設計（手機、平板、桌面適配）
4. 醫師介紹（照片、專長、經歷、時段）
5. 服務項目（科別、檢查、治療項目）
6. 線上掛號（日期、時段、醫師選擇）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'medical-clinic-telemedicine-html': `請幫我建立一個醫療診所遠距醫療型網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：遠距醫療患者、偏遠地區患者、慢性病患者
- 核心功能：視訊看診、線上處方、健康監測、遠距照護
- 設計風格：醫療、科技、便利，使用藍色和綠色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、視訊看診、健康監測、處方管理、照護記錄）
2. 遠距醫療CSS樣式（科技感設計、視訊介面、健康圖表）
3. 響應式設計（手機、平板、桌面適配）
4. 視訊看診（預約系統、視訊通話、診療記錄）
5. 線上處方（處方開立、藥品查詢、用藥提醒）
6. 健康監測（生命徵象記錄、健康趨勢、異常警報）
7. 遠距照護（照護計劃、追蹤提醒、家屬通知）
8. 醫療資訊（健康知識、用藥指南、緊急聯絡）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'community-management-html': `請幫我建立一個簡單的社區管理系統（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：社區住戶和管理員
- 核心功能：公告發布、維修申請、費用繳納、鄰里交流
- 設計風格：親切、實用、使用綠色和白色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、公告、維修、費用、交流、聯絡）
2. 社區專用CSS樣式（親切設計、實用性優先）
3. 響應式設計（手機、平板、桌面適配）
4. 公告系統（重要通知、活動公告、分類）
5. 維修申請（問題描述、照片上傳、進度追蹤）
6. 費用管理（繳費記錄、帳單查詢、線上繳費）
7. 鄰里交流（討論區、活動分享、聯絡資訊）
8. 基本互動功能（表單提交、狀態更新）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'goal-tracking-html': `請幫我建立一個簡單的目標追蹤工具（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：個人用戶和目標導向者
- 核心功能：目標設定、進度追蹤、習慣養成、成就系統
- 設計風格：激勵、清晰、使用橙色和紫色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、目標、進度、習慣、成就、統計）
2. 目標追蹤專用CSS樣式（激勵設計、進度視覺化）
3. 響應式設計（手機、平板、桌面適配）
4. 目標設定（標題、描述、期限、類別）
5. 進度追蹤（完成率、里程碑、時間軸）
6. 習慣養成（每日打卡、連續天數、提醒）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'event-management-html': `請幫我建立一個簡單的活動管理平台（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：活動主辦方和參與者
- 核心功能：活動發布、報名管理、票務系統、活動統計
- 設計風格：活潑、吸引、使用紅色和黃色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、活動、報名、票務、統計、管理）
2. 活動管理專用CSS樣式（活潑設計、吸引力強）
3. 響應式設計（手機、平板、桌面適配）
4. 活動展示（標題、描述、時間、地點、票價）
5. 報名系統（個人資訊、票種選擇、付款）
6. 票務管理（票券生成、驗證、統計）
7. 活動統計（報名人數、收入、參與度）
8. 基本互動功能（報名流程、票務操作）
...
**請依序實作：**
1. 單頁面HTML結構（根據需求設計導航和區塊）
2. 客製化CSS樣式（根據需求設計色彩和佈局）
3. 響應式設計（手機、平板、桌面適配）
4. 核心功能實作（根據需求實作主要功能）
5. 互動功能（根據需求實作用戶互動）
6. 表單處理（根據需求實作表單驗證和提交）
7. 內容管理（根據需求實作內容展示）
