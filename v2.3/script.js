...
請提供完整的程式碼實作和部署指南。`
    ...
    const htmlTemplateCommands = {
        'beauty-html': `請幫我建立一個簡單的美業招募網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：美業從業者（美髮師、美甲師、美容師等）和雇主
- 核心功能：職位展示、作品集展示、聯絡表單、基本資訊頁面
- 設計風格：優雅、專業、視覺吸引力強，使用玫瑰金和米色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、首頁、職位列表、作品集、聯絡我們）
2. 美業專用CSS樣式（色彩、字體、按鈕、卡片設計）
3. 響應式設計（手機、平板、桌面適配）
4. 職位展示區域（美業專業分類、技能標籤）
5. 作品集展示（圖片輪播、美業分類）
6. 聯絡表單（基本驗證、美業相關欄位）
7. 基本互動功能（平滑滾動、表單提交）
8. SEO優化（美業關鍵字、meta標籤）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'restaurant-html': `請幫我建立一個簡單的餐飲業網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：餐廳顧客和潛在客戶
- 核心功能：菜單展示、線上訂位、餐廳介紹、聯絡資訊
- 設計風格：溫馨、誘人、使用暖色調配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、首頁、菜單、關於我們、聯絡）
...
請提供完整的HTML、CSS、JavaScript程式碼，確保可以直接在瀏覽器中運行。`,
        ...
        'fitness-html': `請幫我建立一個簡單的健身中心網站（HTML方案），包含以下功能：

**專案需求：**
- 目標用戶：健身愛好者和潛在會員
- 核心功能：課程展示、教練介紹、會員方案、聯絡預約
- 設計風格：活力、動感、使用橙色和黑色配色
- 技術要求：純HTML + CSS + JavaScript，響應式設計

**請依序實作：**
1. 單頁面HTML結構（導航、首頁、課程、教練、方案、聯絡）
